            ...
            <div class="row">
              <div class="col-12">
                <div class="banner_content">
                  <div class="text-left">
                    <h1 data-aos-delay="1000" data-aos="fade-right" data-aos-easing="linear" data-aos-duration="700" style="color: #06163a; font-size: 34px; padding-bottom: 20px;">{{ $banner->title }}</h1>
                    <h1 data-aos-delay="1300" data-aos="fade-right" data-aos-easing="linear" data-aos-duration="700" style="color: #06163a; font-size: 34px">{{ $banner->description }}</h4>

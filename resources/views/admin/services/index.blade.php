...
<div class="content-header-left col-md-9 col-12 mb-2">
    <div class="row breadcrumbs-top">
        <div class="col-12">
            <h2 class="content-header-title float-left mb-0">Service Settings</h2>
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Service Settings
                    </li>
                </ol>
            </div>
        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-11 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-vertical" action="{{ route('services.store') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="first-name-vertical" style="color:#000; font-size:18px;">Service Title</label>
                                    <input type="text" id="first-name-vertical" class="form-control" name="title" placeholder="Enter Service title">
                                    @error('title')
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" id="email-id-vertical" class="form-control" name="description" placeholder="Service Description"></textarea>
                                    @error('description')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="{{ route('services.delete', $service->id) }}">

...
@section('title')
    {{ config('app.name') }} - Clients Settings
@endsection
...
<div class="content-header-left col-md-9 col-12 mb-2">
    <div class="row breadcrumbs-top">
        <div class="col-12">
            <h2 class="content-header-title float-left mb-0">Clients Settings</h2>
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Clients Settings
                    </li>
                </ol>
            </div>
        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-11 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-vertical" action="{{ route('clients.store') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                   <img src="{{ asset('uploads/clients') }}/{{ $client->image }}" width="200" alt="">
                                </td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="{{ route('clients.delete', $client->id) }}">

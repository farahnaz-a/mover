...
<div class="content-header-left col-md-9 col-12 mb-2">
    <div class="row breadcrumbs-top">
        <div class="col-12">
            <h2 class="content-header-title float-left mb-0">Counters Settings</h2>
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Counters Settings
                    </li>
                </ol>
            </div>
        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-11 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-vertical" action="{{ route('counters.store') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="font-weight-bold">{{ $counter->count }}</span>
                                </td>
                                <td>{{ $counter->title }}</td>
                                <td>
                                   <img src="{{ asset('uploads/counters') }}/{{ $counter->image }}" width="200" alt="">
                                </td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('counters.edit', $counter->id) }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 mr-50"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg>
                                                <span>Edit</span>
                                            </a>
                                            <a class="dropdown-item" href="{{ route('counters.delete', $counter->id) }}">

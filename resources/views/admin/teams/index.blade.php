...
<div class="content-header-left col-md-9 col-12 mb-2">
    <div class="row breadcrumbs-top">
        <div class="col-12">
            <h2 class="content-header-title float-left mb-0">Teams Settings</h2>
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Teams Settings
                    </li>
                </ol>
            </div>
        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-11 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-vertical" action="{{ route('teams.store') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="first-name-vertical" style="color:#000; font-size:18px;">Team Members Name</label>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="email-id-vertical" style="color:#000; font-size:18px;">Team Members Title</label>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="contact-info-vertical" style="color:#000; font-size:18px;">Team Members Image</label>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="{{ route('teams.delete', $team->id) }}">

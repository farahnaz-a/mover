                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="first-name-vertical" class="form-control" name="title" placeholder="Enter Banner title">
                                    @error('title')
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" id="email-id-vertical" class="form-control" name="description" placeholder="Banner Description"></textarea>
                                    @error('description')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                   <img src="{{ asset('uploads/banners') }}/{{ $banner->image }}" width="200" alt="">
                                </td>
                                <td>
                                    <div class="dropdown">

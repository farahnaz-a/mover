...
<div class="content-header-left col-md-9 col-12 mb-2">
    <div class="row breadcrumbs-top">
        <div class="col-12">
            <h2 class="content-header-title float-left mb-0">Works Settings</h2>
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Works Settings
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="col-lg-6 col-md-11 col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add Works</h4>
                </div>
                <div class="card-body">
                    <form class="form form-vertical" action="{{ route('works.store') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="first-name-vertical" style="color:#000; font-size:18px;">Work Title</label>
                                    <input type="text" id="first-name-vertical" class="form-control" name="title" placeholder="Enter Work title">
                                    @error('title')
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" id="email-id-vertical" class="form-control" name="description" placeholder="Work Description"></textarea>
                                    @error('description')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="font-weight-bold">{{ $work->title }}</span>
                                </td>
                                <td>{{ $work->description }}</td>
                                <td>
                                   <img src="{{ asset('uploads/works') }}/{{ $work->image }}" width="200" alt="">
                                </td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="{{ route('works.delete', $work->id) }}">

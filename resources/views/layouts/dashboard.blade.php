    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item @yield('services')"><a class="d-flex align-items-center" href=""><i data-feather='truck'></i><span class="menu-title text-truncate" data-i18n="Service settings">Service Settings</span></a>
                </li> 

                <li class="nav-item @yield('works')"><a class="d-flex align-items-center" href=""><i data-feather='wind'></i><span class="menu-title text-truncate" data-i18n="Work settings">Work Settings</span></a>
                </li> 

                <li class="nav-item @yield('teams')"><a class="d-flex align-items-center" href=""><i data-feather='users'></i><span class="menu-title text-truncate" data-i18n="team settings">Team Settings</span></a>
                </li> 

                <li class="nav-item @yield('testimonials')"><a class="d-flex align-items-center" href=""><i data-feather='command'></i><span class="menu-title text-truncate" data-i18n="testimonial settings">Testimonial Settings</span></a>
                </li> 

                <li class="nav-item @yield('counters')"><a class="d-flex align-items-center" href=""><i data-feather='clock'></i><span class="menu-title text-truncate" data-i18n="counter settings">Counter Settings</span></a>
                </li> 

                <li class="nav-item @yield('blogs')"><a class="d-flex align-items-center" href=""><i data-feather='clipboard'></i><span class="menu-title text-truncate" data-i18n="Blog settings">Blog Settings</span></a>
                </li> 

                <li class="nav-item @yield('clients')"><a class="d-flex align-items-center" href=""><i data-feather='aperture'></i><span class="menu-title text-truncate" data-i18n="Client settings">Client Settings</span></a>
                </li> 

                <li class="nav-item @yield('callouts')"><a class="d-flex align-items-center" href=""><i data-feather='globe'></i><span class="menu-title text-truncate" data-i18n="Callout settings">Callout Settings</span></a>
                </li> 

                <li class="nav-item @yield('contacts')"><a class="d-flex align-items-center" href=""><i data-feather='phone'></i><span class="menu-title text-truncate" data-i18n="Contact settings">Contacts Settings</span></a>
                </li> 

                <li class="nav-item @yield('registrations')"><a class="d-flex align-items-center" href=""><i data-feather='plus-square'></i><span class="menu-title text-truncate" data-i18n="Contact settings">Registration Settings</span></a>
                </li> 
                <li class="nav-item @yield('settings')"><a class="d-flex align-items-center" href=""><i data-feather='settings'></i><span class="menu-title text-truncate" data-i18n="Contact settings">General Settings</span></a>
                </li> 
